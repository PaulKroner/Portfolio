...
<body>
        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link" onclick="window.location.href = '../UPDATEScreen/UpdateInsertScreen.php'">
                      <a href="#">
    ...
    <!-- Tab links -->
        ...
        <div id="bedingungenSelect" class="tabcontent zweiMalDreiSpalten">
            ...
            <!-- kann man sich theoretisch sparen, weil oben schon angefragt
            <script>
            //das muss auch in ausgelagerter Datei gehen
            $(document).ready(function(){
                    $('#tabellenAuswahl').on('change', function() {
        ...
        <div id="exportAnfrage" class="tabcontent zweiMalDreiSpalten">
            ...
            <button class="weiterButton rechtsoben" onclick="window.location.href = '../UPDATEScreen/UpdateInsertScreen.php'">Weiter</button>
        </div>
    </section>
